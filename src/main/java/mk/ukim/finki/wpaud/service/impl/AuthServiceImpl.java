...
import mk.ukim.finki.wpaud.model.exceptions.InavlidUserCredentialsException;
import mk.ukim.finki.wpaud.model.exceptions.InvalidArgumentException;
import mk.ukim.finki.wpaud.model.exceptions.PasswordDoNotMatchException;
...
public class AuthServiceImpl implements AuthService {
    ...
    public User login(String username, String password) {
        ...
        return userRepository.findByUsernameAndPassword(username,
                password).orElseThrow(InavlidUserCredentialsException::new);
    }
